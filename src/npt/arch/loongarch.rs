...
use page_table_multiarch::{PageTable64, loongarch64::LA64MetaData};
use core::arch::asm;
...
// }
pub struct MyLA64MetaData(LA64MetaData);

impl PagingMetaData for MyLA64MetaData {
...
// pub type NestedPageTable<H> = PageTable64<LA64MetaData<GuestPhysAddr>, LA64PTE, H>;

pub type NestedPageTable<H> = PageTable64<MyLA64MetaData, LA64PTE, H>;